...
title_input: 'MedControl — Ввод', title_dashboard: 'MedControl — Табло', title_action: 'MedControl — Приём препаратов', title_settings: 'MedControl — Настройки',
    ...
    settings_intro: 'Интерфейс автоматически использует язык устройства, если перевод доступен. Язык можно изменить вручную в верхней панели приложения.',
    ...
    input_help_4: 'Если препарат отменён врачом или больше не используется, переведите его в Пассивно. Он не будет отображаться в разделе «Приём препаратов» и на Табло.',
    ...
    patient_data: 'Рабочий режим', patient_data_value: 'Локальные данные текущего устройства',
     expected_at: 'Ожидается',
    upcoming_at: 'Предстоит',
    overdue_at: 'Просрочено',
...
hint_name: 'Введите название препарата.',
hint_dose: 'Введите дозу препарата.',
hint_details: 'Заполните поле «Детали».',
hint_times: 'Добавьте хотя бы одно время.',
hint_weekdays: 'Отметьте хотя бы один день недели.',
hint_dates: 'Добавьте хотя бы одну дату.',
hint_period: 'Дата окончания не может быть раньше даты начала.',
hint_duplicate_time: 'Это время уже добавлено.',
...
input_fill_help_4: 'If a required value is missing, the application will show a prompt.', dashboard_title_1: 'Current day states', action_title_1: 'Result capture', row: 'Row', actions: 'Actions', details: 'Details', state: 'State', starts_after: 'Starts from', ends_after: 'Ends on', dates: 'Dates', weekdays_selected: 'Weekdays', mark_time: 'Mark time', choose_action: 'Action', apply_correction: 'Apply correction', correction_help: 'Correction affects only the intake record of the selected row.', schedule_rule: 'Intake rule', selected_row: 'Selected row', unsupported_language: 'No prepared interface was found for the device language. English has been used.', patient_data: 'Working mode', patient_data_value: 'Local data on the current device', expected_at: 'Expected', upcoming_at: 'Upcoming', overdue_at: 'Overdue', hours: 'Hours',
    ...
    period: 'Period',
hint_title: 'Hint',
hint_name: 'Enter the medication name.',
hint_dose: 'Enter the medication dose.',
hint_details: 'Complete the Details field.',
hint_times: 'Add at least one time.',
hint_weekdays: 'Select at least one weekday.',
hint_dates: 'Add at least one date.',
hint_period: 'The end date cannot be earlier than the start date.',
hint_duplicate_time: 'This time has already been added.',
