...
<link rel="icon" href="data:,"><title>${escapeHtml(title)}</title><style>
    ...
    *{box-sizing:border-box} body{margin:0;font-family:Arial,sans-serif;background:var(--bg);color:var(--fg);line-height:1.45}
    ...
    dialog{border:1px solid var(--bd);border-radius:16px;padding:18px;max-width:820px;width:calc(100% - 24px)} .row-history-dialog{
  width:calc(100vw - 24px);
  max-width:none;
  box-sizing:border-box;
} dialog::backdrop{background:rgba(0,0,0,.3)} .right{text-align:right}
